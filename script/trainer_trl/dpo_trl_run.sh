...
#4.loss_type --- bco_pair
#Binary Classifier Optimization for Large Language Model Alignment
#5.use_weighting --- True
#WPO: Enhancing RLHF with Weighted Preference Optimization 
#6.loss_type --- sppo_hard
...
accelerate launch --main_process_port 29501 --config_file=script/accelerate_configs/zero2.yaml \
            ...
            --dataset_name /data/public/dataset/argilla_ultrafeedback-binarized-preferences-cleaned \
