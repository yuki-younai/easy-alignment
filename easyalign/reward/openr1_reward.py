...
from easyalign.reward.math_grader import extract_answer, grade



def understand_reward(prompts, completions, solution, **kwargs):
    # print("##################################")
    # print(len(prompts), len(prompts[0]))
    # a1= prompts[0]
    # a2= prompts[8]
    # for pro in prompts[:8]:
    #     print(pro==a1)
    # for pro in prompts[8:16]:
    #     print(pro==a2)   
    #https://github.com/sail-sg/understand-r1-zero
    if type(completions[0]) == str:
        contents = [completion for completion in completions]
    else:
        contents = [completion[0]["content"] for completion in completions]
    rewards = []
    for content, sol in zip(contents, solution):
        rewards.append(understand_reward_fn(content, sol))
    return rewards
    
def understand_reward_fn(model_response, gt_answer, fast=False):
    #https://github.com/sail-sg/understand-r1-zero
...
# def format_reward(completions, **kwargs):
#     """Reward function that checks if the completion has a specific format with correct tag counts."""
#     rewards = [1.0 for _ in range(len(completions))]
