...
from trl import ModelConfig, ScriptArguments, TrlParser, create_reference_model, get_peft_config, ORPOConfig, ORPOTrainer
...
def train():
    parser = HfArgumentParser((DPOScriptArguments, ORPOConfig, ModelConfig))
    ...
    orpo_trainer.log_metrics("train", metrics)
    orpo_trainer.save_metrics("train", metrics)
    orpo_trainer.save_state()
