...
from trl import ModelConfig, ScriptArguments, TrlParser, create_reference_model, get_peft_config, KTOConfig, KTOTrainer
...
from easyalign.utils.build_datasets import build_kto_dataset
...
def train():
    parser = HfArgumentParser((DPOScriptArguments, KTOConfig, ModelConfig))
    ...
    train_dataset = build_kto_dataset(tokenizer, script_args.dataset_name, training_args.max_length)
    ###################
    # Model init kwargs
    ###################
